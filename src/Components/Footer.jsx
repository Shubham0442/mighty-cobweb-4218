  ...
  return (
    <div>
        ...
        <div className={style.newsDiv}>
          <div>
            ...
            <div className={style.checkDiv}>
                  <input type="checkbox" />
                  <i>I consent to receive YOOX newsletters via email. For further information, please consult the Privacy Policy.</i>
            </div>
            <Button colorScheme="blackAlpha" variant="solid">SIGN UP</Button>
          </div>
        </div>
        <div className={style.sideDiv}>
          <h3>MYOOX</h3>
      ...
      <div className={style.lower3}>
        <h6>POWERED BY YOOX NET-A-PORTER GROUP - COPYRIGHT © 2000-2022 YOOX NET-A-PORTER GROUP S.P.A. - ALL RIGHTS RESERVED - SIAE LICENCE # 401/I/526</h6>
