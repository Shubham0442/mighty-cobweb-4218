...
const MainNavbar = () => {
 ...
 const [show, setShow]= useState(false)
  ...
  return (
    <div>
      <div className={style.mainUpper}>
        <div>
          <Link to="/men">WOMEN</Link>
          <Link to="/men">MEN</Link>
          <Link to="/men">KIDS</Link>
          <Link to="/men">DESIGN + ART</Link>
        </div>
        <div>
          <img src="/Home-images/yoox_logo_colored.jpg" alt="colored" />
        </div>
        <div className={style.mainUpperLast}>
          <Link to="/dream" ml="30px">
            <BiSearch size="22px" />
          </Link>
          <Link to="/dream" ml="30px">
      ...
      <div className={style.mainLower}>
              ...
              <MenuList >
                ...
                >
                  ...
                  <Box display="flex" gap="15px">
                    ...
                    <Box>
                    <Box>
                        <img src="https://www.yoox.com/images/yoox80/banners/6825_7_Balenciaga_M_Small.jpg?634485886601286852" alt="1" />
                        <Text>BALENCIAGA</Text>
                      <Text fontSize="12px">ELEGANCE THAT BREAK THE RULES</Text>
                    </Box>
                    <Box>
                        <img src="https://www.yoox.com/images/yoox80/banners/6825_3_Prada_M_Small.jpg?634485886601286852" alt="2" />
                        <Text>PRADA</Text>
                      <Text fontSize="12px">INNOVATIVE AND ICONIC PATTERNS</Text>
                    </Box>
                    </Box>
                    <Box>
                    </Box>
              ...
              <Portal>
                 <MenuList >
                    ...
                    paddingRight="300px">
                         ...
                         <Box>
                        <img src="https://www.yoox.com/images/yoox80/banners/6824_2_TrendGardenParty_Clothing_DD_M.jpg?634485886601286852" alt="2" />
              ...
              <Portal>
                 <MenuList >
                    ...
                    paddingRight="300px">
                         ...
                         <Box>
                        <img src="https://www.yoox.com/images/yoox80/banners/6824_1_FocusOnSandals_DD_M.jpg?634485886601286852" alt="2" />
                        <Text>FUN IN THE SUN</Text>
                      <Text fontSize="12px">FROM MINIMAL SANDALS TO COLOURFUL SLIDES: ALL THE SEASON MUST-HAVES</Text>
                    </Box>
                    </Box>
                 </MenuList>
              </Portal>
              ...
              <Portal>
                 <MenuList >
                    ...
                    paddingRight="300px">
                         ...
                         <Box>
                        <img src="https://www.yoox.com/images/yoox80/banners/6824_2_TrendGardenParty_Acc_DD_M.jpg?634485886601286852" alt="2" />
                        <Text>THE ECCENTRIC TOUCH</Text>
                      <Text fontSize="12px">OPT FOR INTERESTING AND ORIGINAL ACCESSORIES</Text>
                    </Box>
                    </Box>
                 </MenuList>
              </Portal>
        ...
        <div> 
            <Menu>
                  <MenuButton color="white">8 BY YOOXS</MenuButton>
            </Menu>
        </div>
        <div>
            <Menu>
                  <MenuButton color="white">YOOXSGENS</MenuButton>
            </Menu>
        </div>
        <div>
            <Menu>
        ...
        <div>
            <Menu>
                  <MenuButton color="white">SALES</MenuButton>
            </Menu>
        </div>
      </div>
    </div>
